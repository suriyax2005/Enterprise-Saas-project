...
import com.saas.saas.exception.ForbiddenException;
...
public class UserService {
    ...
    public String updateUserRole(
        ...
        if (user.getEmail().equalsIgnoreCase(currentUser.getEmail())) {
            throw new BadRequestException("You cannot modify your own role to prevent self-demotion.");
        }

        // Allow platform admin to modify roles across all tenants, otherwise restrict to own tenant
        if (!user.getTenant().getId().equals(tenantId) && !"admin@unified.com".equalsIgnoreCase(currentUser.getEmail())) {
